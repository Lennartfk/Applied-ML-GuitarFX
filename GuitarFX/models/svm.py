...
def get_features(dataset_paths, read_csv=True, csv_path="guitar_monophon_mean_features.csv", max_samples_per_classifier=None):
    """
    ...
    if read_csv:
        ...
        X, y, feature_names, label_names = extractor.execute_mean_features(max_samples_per_classifier)
